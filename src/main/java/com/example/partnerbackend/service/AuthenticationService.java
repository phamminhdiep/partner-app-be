...
import com.example.partnerbackend.config.JwtService;
...
import com.example.partnerbackend.repository.UserRepository;
...
public class AuthenticationService {
    ...
    public AuthenticationResponse authenticate(AuthenticationRequest request) {
        ...
        try {
            ...
            // Handle the failure, e.g., return an error response to the client
        }
